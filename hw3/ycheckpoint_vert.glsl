...
vec3 Iamb = vec3(1, 1, 1); // ambient light intensity
vec3 kd = vec3(1, 1, 0);     // diffuse reflectance coefficient
vec3 ka = vec3(0.4, 0.4, 0.1);   // ambient reflectance coefficient
